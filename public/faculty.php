...
<div class="container">
    ...
    <?php foreach ($people as $i => $person): ?>
        <div class="col-md-6 col-lg-4">
            <div class="card shadow-sm fade-card <?= statusClass($person["status"]) ?>" style="--delay: <?= $i * 0.08 ?>s">
                <div class="card-body d-flex gap-3 align-items-start">
                    ...
                    <div>
                        ...
                        <p class="card-subtitle text-muted small mb-2">
                            <?= htmlspecialchars($person["role_title"]) ?> &middot; <?= htmlspecialchars($person["department"]) ?>
                        </p>
                        <span class="badge <?= statusBadgeClass($person["status"]) ?> mb-2">
